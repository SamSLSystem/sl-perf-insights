...
<div id="content-tab-audit" class="slpi-tab-content">
    <div class="audit-analysis-container">
        <h1>Moyennes des Performances</h1>

        <!-- Ligne avec les 2 cartes de résultats -->
        <div class="audit-row">
            <!-- Carte pour les résultats Mobile -->
            <div class="audit-card">
                <h3>Moyenne des Scores Mobile</h3>
                <canvas id="average-mobile-score-chart"></canvas>
                <p>
                ...
                <table class="metrics-table">
                    <tr>
                        <td><span class="icon" id="average-mobile-fcp-icon"></span></td>
                        <td><strong>First Contentful Paint</strong></td>
                        <td><span id="average-mobile-fcp">--</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon" id="average-mobile-lcp-icon"></span></td>
                        <td><strong>Largest Contentful Paint</strong></td>
                        <td><span id="average-mobile-lcp">--</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon" id="average-mobile-tbt-icon"></span></td>
                        <td><strong>Total Blocking Time</strong></td>
                        <td><span id="average-mobile-tbt">--</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon" id="average-mobile-cls-icon"></span></td>
                        <td><strong>Cumulative Layout Shift</strong></td>
                        <td><span id="average-mobile-cls">--</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon" id="average-mobile-speed-index-icon"></span></td>
                        <td><strong>Speed Index</strong></td>
                        <td><span id="average-mobile-speed-index">--</span></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="audit-card">
                <h3>Moyenne des Scores Desktop</h3>
                <canvas id="average-desktop-score-chart"></canvas>
                <p>
                <span class="icon icon-circle score-good"></span> 90-100
                <span class="icon icon-square score-average"></span> 50-89
                <span class="icon icon-triangle score-bad"></span> 0-49
                ...
                <table class="metrics-table">
                    <tr>
                        <td><span class="icon" id="average-desktop-fcp-icon"></span></td>
                        <td><strong>First Contentful Paint</strong></td>
                        <td><span id="average-desktop-fcp">--</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon" id="average-desktop-lcp-icon"></span></td>
                        <td><strong>Largest Contentful Paint</strong></td>
                        <td><span id="average-desktop-lcp">--</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon" id="average-desktop-tbt-icon"></span></td>
                        <td><strong>Total Blocking Time</strong></td>
                        <td><span id="average-desktop-tbt">--</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon" id="average-desktop-cls-icon"></span></td>
                        <td><strong>Cumulative Layout Shift</strong></td>
                        <td><span id="average-desktop-cls">--</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon" id="average-desktop-speed-index-icon"></span></td>
                        <td><strong>Speed Index</strong></td>
                        <td><span id="average-desktop-speed-index">--</span></td>
                    </tr>
                </table>
            </div>
        </div>
